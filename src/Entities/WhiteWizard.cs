...
namespace DesafioDIO.src.Entities
{
    ...
    {
       public WhiteWizard(string Name, int ExperienceLevel, string PowerType, int PowerLevel, int LevelLife) : base (Name, ExperienceLevel, PowerType, PowerLevel, LevelLife)
       {
            this.Name = Name;
