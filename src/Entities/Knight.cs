...
namespace DesafioDIO.src.Entities
{
    ...
    {
        public Knight(string Name, int ExperienceLevel, string PowerType, int PowerLevel, int LevelLife) : base (Name, ExperienceLevel, PowerType, PowerLevel, LevelLife)
       {
            this.Name = Name;
        ...
        public string Attack(int Bonus){
             if (Bonus > 5)
            {
        return this.Name + " Deu um golpe de " + this.PowerType + " com Bonus";
            }else{
